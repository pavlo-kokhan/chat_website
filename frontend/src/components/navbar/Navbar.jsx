    ...
    return <div className="bg-base-100 fixed left-0 top-0 w-full">
        <div className="navbar container mx-auto">
            ...
            <div className="flex-1">
                <a className="btn btn-ghost text-xl text-blue-300">CMS</a>
            </div>
                    ...
                    <div tabIndex={ 0 } role="button" className="btn btn-ghost btn-circle avatar">
                        <div className="w-10 rounded-full">
                            <img alt="Tailwind CSS Navbar component"
                                 src={ authUser ? authUser.profilePic : "https://www.strasys.uk/wp-content/uploads/2022/02/Depositphotos_484354208_S.jpg" }/>
                        </div>
                    </div>

                    <span className="flex items-center text-blue-300 ml-4">{ authUser ? authUser.username : "username" }</span>
                </div>
